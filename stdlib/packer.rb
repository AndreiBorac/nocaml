...
wombat_register_builtin("packer-pack-16-el", 2);
wombat_register_builtin("packer-pack-32-el", 2);

wombat_register_builtin("packer-pack-16-be", 2);
wombat_register_builtin("packer-pack-32-be", 2);
...
let wombat_builtin_packer_minus_pack_minus_16_minus_el (x : wombat_integer) (y : wombat_blob) : wombat_blob = failwith "oops";;
let wombat_builtin_packer_minus_pack_minus_32_minus_el (x : wombat_integer) (y : wombat_blob) : wombat_blob = failwith "oops";;

let wombat_builtin_packer_minus_pack_minus_16_minus_be (x : wombat_integer) (y : wombat_blob) : wombat_blob = failwith "oops";;
let wombat_builtin_packer_minus_pack_minus_32_minus_be (x : wombat_integer) (y : wombat_blob) : wombat_blob = failwith "oops";;
...
let wombatx_builtin_packer_minus_pack_minus_16_minus_el (args : (wombatx_integer, wombatx_blob) wombatxvector2) : wombatx_blob = failwith "oops";;
let wombatx_builtin_packer_minus_pack_minus_32_minus_el (args : (wombatx_integer, wombatx_blob) wombatxvector2) : wombatx_blob = failwith "oops";;

let wombatx_builtin_packer_minus_pack_minus_16_minus_be (args : (wombatx_integer, wombatx_blob) wombatxvector2) : wombatx_blob = failwith "oops";;
let wombatx_builtin_packer_minus_pack_minus_32_minus_be (args : (wombatx_integer, wombatx_blob) wombatxvector2) : wombatx_blob = failwith "oops";;
